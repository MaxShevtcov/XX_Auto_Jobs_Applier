...
- В КОНЦЕ письма ОБЯЗАТЕЛЬНО поставь подпись в формате:
С уважением,
{first_name}
и только ПОСЛЕ имени укажи контакт для связи
- НЕ завершай письмо строкой 'С уважением,' без имени - имя кандидата ОБЯЗАТЕЛЬНО
